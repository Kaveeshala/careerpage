...
const careerDetails = {
    designer: {
        ...
        location: "Remote",
        responsibilities:[
            "Collaborate with cross-functional teams to understand user needs and business goals.",
            ...
            "Work closely with developers to ensure smooth implementation of designs.",
        ...
        requirements: {
            essentialSkills: [
                ...
                "Basic knowledge of front-end technologies (HTML, CSS) to collaborate effectively with developers."
            ],

            preferredQualifications: [
                "Competitive salary & performance bonuses",
                "Flexible working hours & remote-friendly culture",
                "Access to learning programs & career growth opportunities",
    ...
    softwareDeveloper: {
        ...
        culture: {
            perksandBenefits: [
                ...
                "Access to learning programs & career growth opportunities",
                "Health & wellness benefits",
                "Fun team events & a collaborative work environment"
            ]
        }
    },
    japaneese: {
